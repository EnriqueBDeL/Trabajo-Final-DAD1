...
public class ServidorRepository {
    ...
    public static int contarTitulos() { return repoTitulos.getSize(); }
    ...
    public static boolean existeMatricula(String id) { return repoMatriculas.existe(id); }
    public static ArrayList<Matricula> getListaMatriculas() { return repoMatriculas.getTodos(); }

    public static boolean agregarAsignaturaATitulo(String idAsignatura, String idTitulo) {
        if (!existeAsignatura(idAsignatura) || !existeTitulo(idTitulo)) return false;
    ...
    public static ArrayList<Asignatura> getAsignaturasDeTitulo(String idTitulo) {
        ...
        if (asignaturasPorTitulo.containsKey(idTitulo)) {
            for (String id : asignaturasPorTitulo.get(idTitulo)) {
                Asignatura a = repoAsignaturas.get(id);
    ...
    public static boolean eliminarAsignaturaDeTitulo(String idAsignatura, String idTitulo) {
        if (asignaturasPorTitulo.containsKey(idTitulo)) {
            return asignaturasPorTitulo.get(idTitulo).remove(idAsignatura);
        }
        return false;
    }
}